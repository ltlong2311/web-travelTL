        ...
        <div className="favorites-inner pb-2">
          <div className="row align-center mg-bt-40">
            <div className="col-md-12 text-center">
              <p>
                <img
                  src="/img/icon-menu/icon-tour-1.png"
                  alt=""
              ...
              <blockquote className="about-quote">
                ...
                >
                  Những tour du lịch được yêu thích và phổ biến nhất, cập nhật
                  kết quả chọn lọc từ những tour du lịch được nhiều người lựa
                  chọn và có kết quả đánh giá cao!
                </p>
              </blockquote>
            </div>
          </div>
