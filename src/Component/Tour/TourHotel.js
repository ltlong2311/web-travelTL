...
function TourHotel() {
  return (
    <section className="des-content" id="tour-hotel">
      <div className="container">
        <div className="row pb-5">
          ...
          <div className="col-md-12 text-center">
            <h2 className="highlight-underline">KHÁCH SẠN TRONG CHUYẾN</h2>
            <blockquote className="about-quote">
              <p className="text-muted">
                ...
                chúng tôi luôn tìm ra chỗ ở tốt nhất và phù hợp nhất cho chuyến đi của bạn.
              </p>
            </blockquote>
          </div>
          <div className="col-md-12 text-center">
